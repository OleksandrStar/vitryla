    ...
    <div className="HeadBanner  ">
      <div className="relative">
        <Image
          src={HeaderBanner}
          alt={"header banner"}
          className="object-cover object-center w-screen h-[700px] opacity-70"
        />
        <div className="mt-[50px] md:ml-[100px] absolute top-1/2 left-1/2 transform text-center min-w-[250px] w-fit lg:text-nowrap -translate-x-1/2 -translate-y-1/2 rounded-full text-[#54423B] bg-[#D6D6D6]/75 md:text-[24px] text-[20px] lg:text-[30px] p-4 sm:p-4 sm:px-6 px-2">
        ...
        <div className="absolute bottom-[120px] left-1/2 transform translate-y-1/2 mt-[10%] -translate-x-1/2">
          <a
            className="text-nowrap rounded-xl font-bold text-[16px] md:text-[24px] text-[#D6D6D6] hover:text-[#54423B] border-[#54423B] hover:border-[#54423B] border-2 p-4 duration-500 bg-[#54423B]  hover:bg-[#D6D6D6]"
        ...
        <div className="absolute top-[140px] lg:left-[20%] left-[10%] flex flex-col bg-[#D6D6D6]/75 w-fit rounded-full items-center">
          <div className="text-[12px] text-[#54423B] pt-2">За підтримки:</div>

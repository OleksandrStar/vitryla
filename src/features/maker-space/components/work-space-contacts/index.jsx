...
import PhoneLogo from "../../../../public/making-space/images/phone.svg";
import MailLogo from "../../../../public/making-space/images/mail.svg";
import FacebookLogo from "../../../../public/making-space/images/facebookBlue.svg";
  ...
  return (
    <div className="my-12 w-full flex justify-center" id="contacts-MakerSpace">
      <div className="w-full relative flex justify-center items-center flex-col gap-6 max-w-[1280px] p-4">
        <span className="font-bold text-[36px] md:text-[48px] text-center text-[#54423B]">
          Де нас знайти?
        </span>
        <div className="grid grid-cols-1 md:grid-cols-2 w-full justify-center items-center gap-6 text-[#54423B]">
          <div className="flex flex-col gap-6 ">
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center lg:items-start gap-2 justify-center md:justify-start">
                <Image src={AddressLogo} width={36} height={36} alt="address" />
                <span className="text-[#54423B] font-bold text-center  md:text-start max-w-[300px]">
              ...
              <div className="flex items-center gap-2 justify-center md:justify-start">
                ...
                <a
                  ...
                  target="_blank"
                  className="text-[#54423B] font-bold"
                >
                  +380 (97) 363 32 97
                </a>
              </div>

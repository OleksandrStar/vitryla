...
const PartnerItem = ({ partnerData }) => {
  return (
    <div
      className={clsx(
        "group aspect-square transition-all ease-in flex flex-col items-center",
        partnerData.description.length &&
          "hover:z-50 duration-100 hover:scale-110 bg-white hover:shadow rounded-md hover:absolute cursor-pointer",
      )}
    >

        ...
        {partnersList.map((partnerData) => {
          return partnerData.href ? (
            <a
              ...
              className="md:w-1/3 w-1/2 relative"
              target="_blank"
...
const PartnerItem = ({ partnerData }) => {
  return (
    <div className="group aspect-square hover:opacity-100 transition-all ease-in cursor-pointer flex flex-col hover:absolute items-center hover:z-50 duration-100 hover:scale-110 bg-white hover:shadow rounded-md">
      ...
      <div className="hidden group-hover:block text-[14px] text-center text-zinc-500 p-5 transition-all opacity-0 group-hover:opacity-100 ease-in">

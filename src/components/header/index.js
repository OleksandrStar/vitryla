  ...
  return (
    <div className="bg-white w-full flex justify-center items-center fixed top-0 left-0 z-[100000] h-[84px]">
      <div className="w-full max-w-[1360px] p-4 flex justify-between items-center">
        <Link href="/">
        <Image src={LogoImg} alt="logo" width={170} height={80} className="h-auto cursor-pointer"/>
        </Link>
        ...
        <Image src={CloseIcon} width={32} height={32} alt="close" onClick={toggleHamburger}/>
